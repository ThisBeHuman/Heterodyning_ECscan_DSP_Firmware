...
/******************OBSOLETE**********************************
	...
	Action:		Must be called before DDS_start_SPORT.
		...
		Depends on clear SEM_DDS_data_busy semaphore DAI_PB07
************************************************************/
...
*/    
    ...
    // frame sync sent to dai PB07 for status interrupt.
    SRU(SPORT1_FS_O, DAI_PB07_I);
